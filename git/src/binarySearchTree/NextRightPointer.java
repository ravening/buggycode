//Given a binary tree, fill all the rightNextPointers with the 
...
public class NextRightPointer {
	...
	public BTNode getParentNextRight(BTNode node) {
		BTNode tmp = node.nextRight;
