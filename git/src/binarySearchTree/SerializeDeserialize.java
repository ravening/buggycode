package git.src.binarySearchTree;//serialize and desrialize a given tree
...
public class SerializeDeserialize {
	...
	public List<Integer> serialize(BSTNode root) {
	...
	public static void helperSerialize(BSTNode root, ArrayList<Integer> list) {
		if (root == null) {
			list.add(null);
			return;
		}
